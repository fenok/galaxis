...
| preventExcessRequestOnHydrate | `boolean`                                                                                        | If `true`, the query won't be fetched on the client during the hydrate phase, if there is data in the cache. `fetchPolicy` option is ignored.                        | No                                       |
